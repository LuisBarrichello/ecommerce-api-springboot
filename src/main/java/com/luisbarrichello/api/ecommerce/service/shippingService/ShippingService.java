...
public class ShippingService {
    private static final String MELHOR_ENVIO_API_URL =
            "https://sandbox.melhorenvio.com.br/api/v2/me/shipment/calculate";
    private static final String ACCESS_TOKEN = "9vRAtm5ykeExCGkUgc6AHpFlOhZFMdcqAPO8TvAt";
    ...
    public String calculateShipping(ShippingRequestDTO shippingRequestDTO) {
        try {
            ...
            HttpRequest request = HttpRequest.newBuilder()
                    .uri(URI.create(MELHOR_ENVIO_API_URL))
